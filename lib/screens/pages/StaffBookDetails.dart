...
class StaffBookDetails extends StatefulWidget {
  String userEmail;
  String nfcID;
  String userID;
  String userStatus;
  StaffBookDetails({this.userEmail,this.userID,this.userStatus, this.nfcID});

  @override
  _StaffBookDetailsState createState() => _StaffBookDetailsState(userEmail,userID,userStatus,nfcID);
}
...
class _StaffBookDetailsState extends State<StaffBookDetails> {
  String userEmail;
  String userID;
  String nfcID;
  String userStatus;
  String username,programme, telNo, address;
  _StaffBookDetailsState(this.userEmail,this.userID,this.userStatus,this.nfcID);
