...
class Shelf extends StatefulWidget {
  ...
  String userID;
  String userStatus;
  Shelf({this.userEmail,this.userID,this.userStatus, this.nfcID,this.shelfID});

  @override
  _ShelfState createState() => _ShelfState(userEmail,userID,userStatus,nfcID,shelfID);
}
...
class _ShelfState extends State<Shelf> {
  ...
  _ShelfState(this.userEmail,this.userID,this.userStatus,this.nfcID,this.shelfID);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: (){
            Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>ShelfBooks(userEmail: userEmail,userID: userID,userStatus: userStatus,),));
          },
        ),
        title: Text("Shelf"),
      ),
